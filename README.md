...
🌍 **Available in 11 languages**: English · Français · Español · Português · Deutsch · Italiano · Русский · العربية · 日本語 · 中文 · Հայերեն

🔐 **100% local processing** — nothing ever leaves your machine. No account, no telemetry, no cloud upload — GDPR-friendly by design.

![XL-Lift](screenshot-home.png)
...
Two ways to try XL-Lift:

- 🖥 **Desktop (Windows)** — the full app experience, free beta build
- 🌐 **Web** — try it instantly in your browser, no install needed: **[artur006.github.io/Xl-lift/](https://artur006.github.io/Xl-lift/)**

Both the desktop and web betas have export locked — full export unlocks with the paid version.

This repository contains the compiled beta build only — no source code.

👉 **[Download the free desktop beta](../../releases/latest)** (export locked)
👉 **[Try the web beta](https://artur006.github.io/Xl-lift/)** (export locked)
...
![Parsing](screenshot-parsing.png)
...
> ⚠️ Navigation shortcuts only let you go **back** to a previous step — you can't skip ahead to a step that hasn't been validated yet.
